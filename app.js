...
const allItems = [...animals, ...kitchen, ...vehicles, ...electronics, ...clothing, ...vegetables, ...weather,
    {
        id: "crow",
        name: "Crow",
...
function renderGallery() {
    ...
    filtered.forEach(item => {
        ...
        // Dynamic image dimensions — kitchen, vehicles, electronics, vegetables, and weather only have 50x50
        const res = (item.group === "kitchen" || item.group === "vehicles" || item.group === "electronics" || item.group === "vegetables" || item.group === "weather") ? "50x50" : spriteResolution;
...
function openModal(item) {
    ...
    // Set image — kitchen, vehicles, electronics, vegetables, and weather only have 50x50
    const res = (item.group === "kitchen" || item.group === "vehicles" || item.group === "electronics" || item.group === "vegetables" || item.group === "weather") ? "50x50" : spriteResolution;
    const displaySrc = item.filename.replace("_50x50.png", `_${res}.png?v=clean`);
